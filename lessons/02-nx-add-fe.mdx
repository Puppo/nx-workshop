...
In this section, we add to our workspace a Frontend app and a frontend library
...
Now starting to add our new Angular Application. Before add the application we
have to install e @nrwl dependence specialized to manage angular framework
